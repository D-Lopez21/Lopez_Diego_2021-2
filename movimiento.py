...
def movimiento(users, Games, User):
    ...
    contador_plaza = 0
    contador_servidor = 0
    while not "Llaves del carro" in inventario:
        ...
        if direccion == 'f':
                        ...
                        if direccion == 'f':
                            while True:                                
                                ...
                                if direccion == 'b':
                                    ...
                                    if "titulo universitario" in inventario:
                                        print("Ya obtuviste el objeto, pa que quieres volver a jugar?")   
                                    else:
                                        numero = Numero.Numero(lugar = 4, interaccion = 2)
                                        inventario.append("titulo universitario")
                                        print(inventario)
                                elif direccion == 'c':
                                    while True:
                                        ...
                                        if respuesta == 'y':
                                            ...
                                            inventario.append("Llaves del carro")
                                            pass
                                        elif respuesta == 'n':
                                            break
                                        elif direccion == 'b':
                            ...
                            while True:
                                if "HDMI" in inventario and "carnet" in inventario:                                
                                        print("Ya obtuviste el objeto, pa que quieres volver a jugar?")
                            ...
                            while True:
                                if "contraseña" in inventario and "llave" in inventario:
                                    print("Ya obtuviste el objeto, pa que quieres volver a jugar?")
            ...
            if "llave" in inventario:    
                ...
                print(inventario)
            elif "Mensaje: Si estas gradudado puedes pisar el Samán" in inventario and "llave" in inventario:
                print("Ya obtuviste el objeto, pa que quieres volver a jugar?")
                pass
            else:
